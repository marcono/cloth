...
build:
	gcc $(INCLUDES) -g -pthread -o cloth main.c ./utils/heap.c ./utils/array.c ./utils/list.c ./simulator/event.c ./simulator/initialize.c ./protocol/protocol.c ./protocol/routing.c   $(LIBS) 
run:
