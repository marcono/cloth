...
** TODO creare heap events da passare a funzioni
*** DONE separare events da payments
*** TODO creare funzione initialize_events che crea i primi eventi a partire dai pagamenti
** TODO creare struct simulator che contiene rimanenti variabili globali (e.g. random generator, simulator_time)
* TODO input e output
