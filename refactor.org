...
** TODO modifica path dei file della topologia in initialize_topology_preproc
** DONE fare due cartelle: src, include
** TODO fare file initialization.c dove vengono messi tutti gli initialize 
** TODO fare file network.c dove ci sono i vari create_channel create_node
** TODO fare file payment.c
